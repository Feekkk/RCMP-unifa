...
$totalApplications = 0;
try {
    $stmt = $pdo->query('SELECT COUNT(*) FROM applications WHERE status_id = 2');
...
<head>
    ...
    <title>Committee Dashboard — RCMP UniFa</title>
    ...
    <div class="app">
        ...
        <div class="main-content">
            <header class="dashboard-header">
                <h1 class="dashboard-title">Committee Dashboard</h1>
                <div class="user-menu">
            ...
            <main class="main-grid">
                <section class="hero-card">
                    ...
                    <p>View and review student fund applications as a committee member.</p>
