...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .hero-card .btn-primary { display: inline-flex; align-items: center; padding: 0.65rem 1.25rem; border-radius: 999px; background: #0f1419; color: #f9fafb; font-size: 0.875rem; font-weight: 600; text-decoration: none; transition: transform 0.1s, box-shadow 0.15s; }
        .hero-card .btn-primary:hover { transform: translateY(-1px); box-shadow: 0 4px 12px rgba(15,20,25,0.3); }
    ...
    <div class="app">
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <a href="users.php"><svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"/></svg>Manage user</a>
        ...
        <div class="main-content">
            ...
            <main class="main-grid">
                <section class="hero-card">
                    ...
                    <p>Review and approve student fund applications. View pending submissions and update status.</p>
                    <a href="applications.php" class="btn-primary">View applications</a>
                </section>
                <div class="stat-cards">
                    ...
                    <div class="stat-card stat-card--light">
                        ...
                        <div class="icon">
                            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1z"/></svg>
                        </div>
                    </div>
                </div>
            </main>
